                        ...
                        <div className="category-row centered">
                            <div className="category-scroll" ref={scrollRef} role="list">
                                ...
                                <Link to="/Bangles-Bracelets" className="card-link" role="listitem" aria-label="Bangles & Bracelets">
                                    ...
                                    <div className="card-label">Bangles & Bracelets</div>
                                </Link>
                                ...
                                <Link to="/Rings" className="card-link" role="listitem" aria-label="Rings">
                                    ...
                                    <div className="card-label">Rings</div>
                                </Link>

                                {/* 5 */}
                                <Link to="/Jewellery-Sets" className="card-link" role="listitem" aria-label="Jewellery Sets">
                                    <div className="card-media" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?q=80&w=2070&auto=format&fit=crop')` }}>
                                        <div className="card-overlay">Shop Now</div>
                                    </div>
                                    <div className="card-label">Jewellery Sets</div>
                                </Link>
                            </div>
                        </div>
                    </div>
