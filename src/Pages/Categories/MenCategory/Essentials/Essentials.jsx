...
function Essentials() {
  ...
  const bestSellers = [
    { image: "https://images.unsplash.com/photo-1503341455253-b2e723bb3dbb?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Cotton Briefs Pack", price: "₹ 799", oldPrice: "₹ 999" },
    { image: "https://plus.unsplash.com/premium_photo-1673735186578-1a6cd08b8100?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Premium Socks Set", price: "₹ 599", oldPrice: "₹ 799" },
    { image: "https://images.unsplash.com/photo-1728718248311-2fdb76913d94?q=80&w=871&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Leather Belt", price: "₹ 1299", oldPrice: "₹ 1599" },
    { image: "https://plus.unsplash.com/premium_photo-1673827311290-d435f481152e?q=80&w=387&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Classic Wallet", price: "₹ 999", oldPrice: "₹ 1299" },
    { image: "https://images.unsplash.com/photo-1512374382149-233c42b6a83b?q=80&w=435&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Baseball Cap", price: "₹ 699", oldPrice: "₹ 899" },
    { image: "https://images.unsplash.com/photo-1688573156881-c6ae02ef0a32?q=80&w=436&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", title: "Sport Watch", price: "₹ 2499", oldPrice: "₹ 2999" },
  ];
    ...
    <>
      ...
      <div className="layout-container">
        <section className="essentials-hero">
          <div>
            <h1>Essential. Everyday. Excellence.</h1>
            <p>Discover our collection of daily essentials, designed for modern living.</p>
            ...
            <div className="grid" role="list">
              <div className="carousel-container">
                ...
                <div className="carousel" ref={carouselRef}>
                  ...
                  <div className="card-link" role="listitem" onClick={() => navigate('/loungewear')} style={{ cursor: 'pointer' }}>
                    <div className="card-media" style={{
                    ...
                    <div className="card-label">Loungewear</div>
                  </div>
                  <div className="card-link" role="listitem" onClick={() => navigate('/Trunks')} style={{ cursor: 'pointer' }}>
                    ...
                    <div className="card-label">Trunks</div>
                  </div>
          ...
          <div className="occasions">
            ...
            <div className="occasions-grid">
              <a href="#" className="occasion-card">
                ...
                <div className="occasion-overlay"><h3>Daily Essentials</h3></div>
              </a>
              <a href="#" className="occasion-card">
                ...
                <div className="occasion-overlay"><h3>Travel Accessories</h3></div>
              </a>
              <a href="#" className="occasion-card">
                ...
                <div className="occasion-overlay"><h3>Gift Sets</h3></div>
              </a>
            </div>
          </div>
        </section>
