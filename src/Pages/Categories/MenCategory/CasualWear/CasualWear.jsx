  ...
  return (
    <>
      ...
      <div className="layout-container">
        <section className="casualwear-hero">
          <div>
            <h1>Stay Effortless. Stay Casual.</h1>
            <p>Discover our new collection of casual wear, designed for comfort and style.</p>
            ...
            <div className="grid" role="list">
              <div className="carousel-container">
                ...
                <div className="carousel" ref={carouselRef}>
                  ...
                  <div className="card-link" role="listitem" onClick={() => navigate('/Nightsuits')} style={{ cursor: 'pointer' }}>
                    <div className="card-media" style={{
                    ...
                    <div className="card-label">Night Suits</div>
                  </div>
                </div>
