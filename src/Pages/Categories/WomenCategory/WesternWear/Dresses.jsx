...
const categories = [
  ...
  { id: 2, image: 'https://images.unsplash.com/photo-1673936993367-b7cd74f26da5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d29tZW4lMjBhJTIwbGluZSUyMGRyZXNzfGVufDB8fDB8fHww', label: 'A-line' },
  { id: 3, image: 'https://images.unsplash.com/photo-1644846146183-1539a55de064?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHNoZWF0aCUyMGRyZXNzfGVufDB8fDB8fHww', label: 'sheath' },
  { id: 4, image: 'https://plus.unsplash.com/premium_photo-1675107357990-b12bc39e95c5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8d3JhcCUyMGRyZXNzfGVufDB8fDB8fHww', label: 'wrap dress' },
  { id: 5, image: 'https://images.unsplash.com/photo-1759992878336-a5dd342ea245?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fG1heGklMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3Ds://user-gen-media-assets.s3.amazonaws.com/seedream_images/6374feb2-ae27-415e-a08b-6b698e2e0196.png', label: 'maxi' },
  { id: 6, image: 'https://images.unsplash.com/photo-1762154057377-cc9d3dd6900c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fG1pZGklMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3D', label: 'midi' },
  { id: 7, image: 'https://plus.unsplash.com/premium_photo-1727427850318-35cb18b7836b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fG1pbmklMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3D', label: 'mini' },
  { id: 8, image: 'https://plus.unsplash.com/premium_photo-1664372388015-ec443ab9db68?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c2hpcnQlMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3D', label: 'shirt dress' },
  { id: 9, image: 'https://images.unsplash.com/photo-1666933545854-7e556d05faf9?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHNrYXRlciUyMGRyZXNzfGVufDB8fDB8fHww', label: 'skater' },
  { id: 10, image: 'https://media.istockphoto.com/id/1709916570/photo/sitting-on-stairs.jpg?s=612x612&w=0&k=20&c=sZ07vaQjYB7siH5dFaVWxmZdbdBB0fhSASMoilUuLXI=', label: 'asymmetrical' },
  { id: 11, image: 'https://media.istockphoto.com/id/1699038012/photo/young-beautiful-woman-in-summer-dress-standing-against-old-door.jpg?s=612x612&w=0&k=20&c=ktXPCEzCJhe2tHqXvxrvjiXpdUbTqazXD1sNbzyvnDU=', label: 'off-shoulder' },
  { id: 12, image: 'https://plus.unsplash.com/premium_photo-1671718112062-7b65562653bb?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aGFsdGVyJTIwbmVjayUyMGRyZXNzfGVufDB8fDB8fHww', label: 'halter neck' },
  { id: 13, image: 'https://plus.unsplash.com/premium_photo-1682097473706-8bb732fe84b8?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', label: 'tunic' },
  { id: 14, image: 'https://user-gen-media-assets.s3.amazonaws.com/seedream_images/c22f8e76-106f-4c16-b96e-76d19f8a3b67.png', label: 'pinafore' },
  { id: 15, image: 'https://media.istockphoto.com/id/1393634672/photo/studio-shot-of-floating-long-silk-camisole-dress.jpg?s=612x612&w=0&k=20&c=SFAlTTE22a6xTSsx4AnTk2WFKkLOksp4gYr4yGTxz68=', label: 'camisole' },
];
