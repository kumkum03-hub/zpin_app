...
const categories = [
  { id: 1, image: 'https://media.istockphoto.com/id/2172528926/photo/sexy-girl-in-red-dress-beautiful-slim-model-in-silk-spaghetti-strap-gown-fashion-woman-over.jpg?s=612x612&w=0&k=20&c=XfUMOLUqR4C_O6dTMQpTeZKuMtzNc4xMpaHdUAc2iZQ=', label: 'Running Tees' },
  { id: 2, image: 'https://images.unsplash.com/photo-1673936993367-b7cd74f26da5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d29tZW4lMjBhJTIwbGluZSUyMGRyZXNzfGVufDB8fDB8fHww', label: 'Running Shorts' },
  { id: 3, image: 'https://images.unsplash.com/photo-1644846146183-1539a55de064?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHNoZWF0aCUyMGRyZXNzfGVufDB8fDB8fHww', label: 'Track Leggings' },
  { id: 4, image: 'https://plus.unsplash.com/premium_photo-1675107357990-b12bc39e95c5?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8d3JhcCUyMGRyZXNzfGVufDB8fDB8fHww', label: 'Windcheaters' },
  { id: 5, image: 'https://images.unsplash.com/photo-1759992878336-a5dd342ea245?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fG1heGklMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3Ds://user-gen-media-assets.s3.amazonaws.com/seedream_images/6374feb2-ae27-415e-a08b-6b698e2e0196.png', label: 'Lightweight Jackets' },
  { id: 6, image: 'https://images.unsplash.com/photo-1762154057377-cc9d3dd6900c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fG1pZGklMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3D', label: 'Running Sports Bra' },
  { id: 7, image: 'https://plus.unsplash.com/premium_photo-1727427850318-35cb18b7836b?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fG1pbmklMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3D', label: 'Reflective Gear' },
  { id: 8, image: 'https://plus.unsplash.com/premium_photo-1664372388015-ec443ab9db68?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c2hpcnQlMjBkcmVzc3xlbnwwfHwwfHx8MA%3D%3D', label: 'Arm Bands' },
  { id: 9, image: 'https://images.unsplash.com/photo-1666933545854-7e556d05faf9?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHNrYXRlciUyMGRyZXNzfGVufDB8fDB8fHww', label: 'Headbands & Caps' },
  { id: 10, image: 'https://media.istockphoto.com/id/1709916570/photo/sitting-on-stairs.jpg?s=612x612&w=0&k=20&c=sZ07vaQjYB7siH5dFaVWxmZdbdBB0fhSASMoilUuLXI=', label: 'Running Shoes' },
];
    ...
    <>
      ...
      <div className="layout-container">
        ...
        <section className="container">
          <div className="page-header">
            <h1 className="title">Running Wear</h1>
