  ...
  return (
    <>
      ...
      <div className="layout-container">
        <section className="women-sportswear-hero">
          <div>
            <h1>Move with Confidence. Embrace Sports Wear.</h1>
            <p>Discover our new collection of sports wear, designed for performance and style.</p>
            ...
            <div className="grid" role="list">
              <div className="carousel-container">
                ...
                <div className="carousel" ref={carouselRef}>
                  <div className="card-link" role="listitem" onClick={() => navigate('/Women/SportsWear/ActiveWear')} style={{ cursor: 'pointer' }}>
                    ...
                    <div className="card-label">Activewear</div>
                  </div>
                  <div className="card-link" role="listitem" onClick={() => navigate('/Women/SportsWear/TrainingGym')} style={{ cursor: 'pointer' }}>
                    <div className="card-media" style={{
                    ...
                    <div className="card-label">Training & Gym</div>
                  </div>
                  <div className="card-link" role="listitem" onClick={() => navigate('/Women/SportsWear/RunningWear')} style={{ cursor: 'pointer' }}>
                    <div className="card-media" style={{
                    ...
                    <div className="card-label">Running Wear</div>
                  </div>
                  <div className="card-link" role="listitem" onClick={() => navigate('/Women/SportsWear/YogaStudio')} style={{ cursor: 'pointer' }}>
                    <div className="card-media" style={{
                    ...
                    <div className="card-label">Yoga & Studio</div>
                  </div>
                  <div className="card-link" role="listitem" onClick={() => navigate('/Women/SportsWear/OutdoorAthleisure')} style={{ cursor: 'pointer' }}>
                    <div className="card-media" style={{
                    ...
                    <div className="card-label">Outdoor & Athleisure</div>
                  </div>
                </div>
...
export default WomenSportsWear;
