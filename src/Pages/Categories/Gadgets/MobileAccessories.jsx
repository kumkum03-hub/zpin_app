            ...
            <div className="category-row centered">
              <div className="category-scroll" ref={scrollRef} role="list">
                ...
                <Link to="/Sunglasses" className="card-link" role="listitem" aria-label="Sunglasses">
                  ...
                  <div className="card-label">Mobile Covers</div>
                </Link>
                ...
                <Link to="/Blue-Light" className="card-link" role="listitem" aria-label="Blue Light Glasses">
                  ...
                  <div className="card-label">Screen Guards</div>
                </Link>
                ...
                <Link to="/Reading-Glasses" className="card-link" role="listitem" aria-label="Reading Glasses">
                  ...
                  <div className="card-label">Mobile Holders</div>
                </Link>

                {/* 4 */}
                <Link to="/Frames" className="card-link" role="listitem" aria-label="Frames">
                  <div className="card-media" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1577803645773-f96470509666?q=80&w=2070&auto=format&fit=crop')` }}>
                    <div className="card-overlay">Shop Now</div>
                  </div>
                  <div className="card-label">Cables</div>
                </Link>
              </div>
            </div>
          </div>
